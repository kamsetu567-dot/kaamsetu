      ...
      <>
        ...
        <div className="bg-green-50 rounded-2xl border-2 border-green-500 p-4 space-y-3">
          ...
          <div className="bg-green-100 rounded-xl px-3 py-2 text-center">
            <p className="text-green-700 text-sm font-hindi">📞 Client थोड़ी देर में call करेगा — फ़ोन पास रखें</p>
            <p className="text-green-600 text-xs mt-0.5">Client will call you shortly. Keep your phone nearby.</p>
          </div>
