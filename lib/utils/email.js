  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;border:1px solid #e5e7eb;border-radius:12px;">
        ...
        <a href="https://www.kaamsetu.live/admin" style="display:inline-block;margin-top:4px;background:#0f172a;color:#fff;font-weight:700;padding:12px 28px;border-radius:10px;text-decoration:none;">View in Admin Panel</a>
        <hr style="margin:24px 0;border:none;border-top:1px solid #e5e7eb;" />
