...
export function adminLogout() {
  ...
  // Drop any impersonation record too — otherwise an abandoned session's stash
  // survives the next admin login and its Exit would restore the OLD admin
  // token over the fresh one, logging them straight back out.
